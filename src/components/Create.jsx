...
const Create = ({ submitBtn }) => {
  ...
  return (
    <div className="p-10">
      ...
      <form class="max-w-md mx-auto mt-32">
        <div class="">
          <select
            id="countries"
            value={currency}
          ...
          <button
            ...
            class="focus:outline-none mt-72 px-10 ml-80 text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
          >
            Create
          </button>
        </div>
